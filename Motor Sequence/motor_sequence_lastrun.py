...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ADMIN\\Desktop\\Motor Sequence\\motor_sequence_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=50.0, method='sequential', 
        ...
        trialList=data.importConditions('motor_sequence_variable_file.csv'),
    ...
    for thisTrial_2 in trials_2:
        ...
        _key_resp_2_allKeys = []
        # keep track of which components have finished
        random_2Components = [fixation_2, line_01, line_02, line_03, line_04, probe_2, key_resp_2]
